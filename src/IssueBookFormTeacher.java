...
public class IssueBookFormTeacher extends JFrame {
	static IssueBookFormTeacher frame;
	...
	public static void main(String[] args) {
		EventQueue.invokeLater(new Runnable() {
			public void run() {
				try {
					frame = new IssueBookFormTeacher();
	...
	public IssueBookFormTeacher() {
		...
		JLabel lblTeacherContact = new JLabel("Contact:");
		...
		btnIssueBook.addActionListener(new ActionListener() {
                    ...
                    public void actionPerformed(ActionEvent e) {
                        ...
                        int teacherid=Integer.parseInt(textField_2.getText());
                        String teachername=textField_3.getText();
                        String teachercontact=textField_4.getText();
                        ...
                        if(IssueBookDaoTeacher.checkBook(bookcallno)){
                            
                            int i=IssueBookDaoTeacher.save(bookcallno, teacherid, teachername, teachercontact,Idate,Rdate);
                            if(i>0){
                                try {
                                    sendReminderEmail(teachername, teacherid, bookcallno, Rdate);
                                } catch (MessagingException ex) {
                                    Logger.getLogger(IssueBookForm.class.getName()).log(Level.SEVERE, null, ex);
                                }
                                JOptionPane.showMessageDialog(IssueBookFormTeacher.this,"Book issued successfully!");
                                TeacherSuccess.main(new String[]{});
                                frame.dispose();
                                
                            }else{
                                JOptionPane.showMessageDialog(IssueBookFormTeacher.this,"Sorry, unable to issue!");
                            }//end of save if-else
                            
                        }else{
                            JOptionPane.showMessageDialog(IssueBookFormTeacher.this,"Sorry, Callno doesn't exist!");
		...
		JLabel lblNewLabel_1 = new JLabel("Note: Please check Teacher ID Carefully before issuing book!");
					...
					.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
						.addGroup(gl_contentPane.createSequentialGroup()
							.addGroup(gl_contentPane.createParallelGroup(Alignment.LEADING)
								...
								.addComponent(lblTeacherName, GroupLayout.PREFERRED_SIZE, 108, GroupLayout.PREFERRED_SIZE)
								.addComponent(lblTeacherContact, GroupLayout.PREFERRED_SIZE, 100, GroupLayout.PREFERRED_SIZE)
		...
		gl_contentPane.setVerticalGroup(
			gl_contentPane.createParallelGroup(Alignment.TRAILING)
				.addGroup(gl_contentPane.createSequentialGroup()
					...
					.addGap(26)
					.addGroup(gl_contentPane.createParallelGroup(Alignment.BASELINE)
						.addComponent(lblTeacherContact)
		...
		contentPane.setLayout(gl_contentPane);
         ...
         private void sendReminderEmail(String teacherName, int teacherId, String bookCallNo, String returnDate) throws MessagingException {
        ...
        try {
            ...
            String query = "SELECT teacheremail FROM teachertable WHERE teacherid = ?";
            
            // Create PreparedStatement
            statement = connection.prepareStatement(query);
            statement.setInt(1, teacherId); // Set teacherId parameter
            ...
            if (resultSet.next()) {
                // Get the teacher email from the result set
                String teacherEmail = resultSet.getString("teacheremail");
                
                // Send email to teacher
                EmailSender.sendEmail(teacherEmail, subject, message);
            } else {
                JOptionPane.showMessageDialog(frame, "Student email not found for teacher ID: " + teacherId,
                        "Error", JOptionPane.ERROR_MESSAGE);
            }
        } catch (java.sql.SQLException | MessagingException ex) {
