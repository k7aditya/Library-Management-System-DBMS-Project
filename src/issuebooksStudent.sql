...
--
-- Table structure for table `issuebooksStudent`
--

CREATE TABLE IF NOT EXISTS `issuebooksStudent` (
...
--
-- Dumping data for table `issuebooksStudent`
--

INSERT INTO `issuebooksStudent` (`id`, `bookcallno`, `studentid`, `studentname`, `studentcontact`, `issueddate`) VALUES
