...
//    private EmailSender emailSender=new EmailSender();
    ...
    public StudentSignup() {
        ...
        JLabel lblStudentSignupForm = new JLabel("Student Signup Form");
        lblStudentSignupForm.setForeground(Color.BLACK);
        lblStudentSignupForm.setFont(new Font("Tahoma", Font.PLAIN, 18));
        ...
        btnSignup.addActionListener((ActionEvent e) -> {
            ...
            if (idStr.isEmpty() || name1.isEmpty() || phone.isEmpty() || email.isEmpty() || password.isEmpty()) {
                JOptionPane.showMessageDialog(StudentSignup.this, "All fields are required", "Error", JOptionPane.ERROR_MESSAGE);
            } else if (!email.matches("^[A-Za-z0-9+_.-]+@iiita\\.ac\\.in$")) { // Check email format
                JOptionPane.showMessageDialog(StudentSignup.this, "Please enter your college email id.", "Error", JOptionPane.ERROR_MESSAGE);
            } else {
                int id;
                try {
                    id = Integer.parseInt(idStr);
                } catch (NumberFormatException ex) {
                    JOptionPane.showMessageDialog(StudentSignup.this, "ID must be a number", "Error", JOptionPane.ERROR_MESSAGE);
                    return;
                }

                if (StudentDao.checkRollNoExistence(id)) {
                    JOptionPane.showMessageDialog(StudentSignup.this, "Roll number already exists", "Error", JOptionPane.ERROR_MESSAGE);
                } 
                else if(StudentDao.checkEmailExistence(email)){
                    JOptionPane.showMessageDialog(StudentSignup.this, "Email already exists", "Error", JOptionPane.ERROR_MESSAGE);
                }
                else {
                     String verificationCode = generateVerificationCode();
                     sendVerificationEmail(name1, email, verificationCode);
                    ...
                    do {
                        ...
                        int option = JOptionPane.showConfirmDialog(StudentSignup.this, message, "Verification", JOptionPane.OK_CANCEL_OPTION);
                        if (option == JOptionPane.OK_OPTION) {
                            ...
                            if (verifyCode(enteredCode, verificationCode)) {
                                ...
                                StudentDao.save(name1, password, id, phone, email);
                                StudentSuccess.main(new String[]{});
                                frame.dispose();
                                JOptionPane.showMessageDialog(StudentSignup.this, "Signup successful!", "Success", JOptionPane.INFORMATION_MESSAGE);
                            } else {
                                // Verification code incorrect
                                JOptionPane.showMessageDialog(StudentSignup.this, "Incorrect verification code. Please try again.", "Error", JOptionPane.ERROR_MESSAGE);
                            }
                        } else {
                            // User cancelled the verification process
                            JOptionPane.showMessageDialog(StudentSignup.this, "Verification cancelled. Signup aborted.", "Info", JOptionPane.INFORMATION_MESSAGE);
        ...
        // Update the GroupLayout to include the new email field
            ...
            gl_contentPane.createParallelGroup(GroupLayout.Alignment.LEADING)
                .addGroup(gl_contentPane.createSequentialGroup()
                    .addGroup(gl_contentPane.createParallelGroup(GroupLayout.Alignment.LEADING)
                        .addGroup(gl_contentPane.createSequentialGroup()
                            .addGap(140)
                            .addComponent(lblStudentSignupForm))
                        .addGroup(gl_contentPane.createSequentialGroup()
                            .addGap(19)
