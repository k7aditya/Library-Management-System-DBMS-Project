...
public class LibrarianSuccess extends JFrame {
	...
	public LibrarianSuccess() {
		...
		setBounds(100, 60, 450, 770);
		contentPane = new JPanel(){
            // Paint the background image
            @Override
            public void paintComponent(Graphics g) {
                super.paintComponent(g);
                Image img = new ImageIcon("D:\\New folder (6)\\background.jpg").getImage();
		...
		lblLibrarianSection.setFont(new Font("Tahoma", Font.BOLD, 22));
                lblLibrarianSection .setForeground(Color.BLACK);
		...
		btnUpdatebutton.setFont(new Font("Tahoma", Font.PLAIN, 13));
...
//		btnIssueBook.setFont(new Font("Tahoma", Font.PLAIN, 13));
		...
		JButton btnViewIssuedBooks = new JButton("View Issued Books By Student");
		...
		btnViewIssuedBooks.setFont(new Font("Tahoma", Font.PLAIN, 13));
                ...
                JButton btnViewIssuedBooksTeacher = new JButton("View Issued Books By Teacher");
		btnViewIssuedBooksTeacher.addActionListener(new ActionListener() {
			public void actionPerformed(ActionEvent e) {
				ViewIssuedBooksTeacher.main(new String[]{});
			}
		});
		btnViewIssuedBooksTeacher.setFont(new Font("Tahoma", Font.PLAIN, 13));
...
//			}
//		});
//                btnViewStudent.setFont(new Font("Tahoma", Font.PLAIN, 13));
...
//						.addComponent(btnReturnBook, GroupLayout.PREFERRED_SIZE, 191, GroupLayout.PREFERRED_SIZE)
						.addComponent(btnViewIssuedBooks, GroupLayout.PREFERRED_SIZE, 191, GroupLayout.PREFERRED_SIZE)
                                                .addComponent(btnViewIssuedBooksTeacher, GroupLayout.PREFERRED_SIZE, 191, GroupLayout.PREFERRED_SIZE)
...
//					.addComponent(btnIssueBook, GroupLayout.PREFERRED_SIZE, 37, GroupLayout.PREFERRED_SIZE)
					...
					.addGap(18)
                                        .addComponent(btnViewIssuedBooksTeacher, GroupLayout.PREFERRED_SIZE, 37, GroupLayout.PREFERRED_SIZE)
